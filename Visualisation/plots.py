...
# 		if key==column:
# 			sns.lineplot(x="Time", y=key,ci=95,data=df,ax=ax[0])
# 			ax[0].set_title('all ages')
# 		elif '0-9' in key:
# 			if key.startswith(column):
# 				sns.lineplot(x="Time", y=key,ci=95,data=df,ax=ax[1])
# 				ax[1].set_title('<9 years')
# 		elif 'Oct-19' in key:
# 			if key.startswith(column):
# 				sns.lineplot(x="Time", y=key,ci=95,data=df,ax=ax[2])
# 				ax[2].set_title('10-19 years')
# 		elif '20-29' in key:
# 			if key.startswith(column):
# 				sns.lineplot(x="Time", y=key,ci=95,data=df,ax=ax[3])
# 				ax[3].set_title('20-29 years')
# 		elif '30-39' in key:
# 			if key.startswith(column):
# 				sns.lineplot(x="Time", y=key,ci=95,data=df,ax=ax[4])
# 				ax[4].set_title('30-39 years')
# 		elif '40-49' in key:
# 			if key.startswith(column):
# 				sns.lineplot(x="Time", y=key,ci=95,data=df,ax=ax[5])
# 				ax[5].set_title('40-49 years')
# 		elif '50-59' in key:
# 			if key.startswith(column):
# 				sns.lineplot(x="Time", y=key,ci=95,data=df,ax=ax[6])
# 				ax[6].set_title('50-59 years')
# 		elif '60-69' in key:
# 			if key.startswith(column):
# 				sns.lineplot(x="Time", y=key,ci=95,data=df,ax=ax[7])
# 				ax[7].set_title('60-69 years')
# 		elif '70+' in key:
# 			if key.startswith(column):
# 				sns.lineplot(x="Time", y=key,ci=95,data=df,ax=ax[8])
...
def plot_by_age_all(df):
	...
	for column in columns_to_plot:
		for key in df.columns:
			if key==column:
				sns.lineplot(x="Time", y=key,ci=95,data=df,ax=ax[i,0])
				ax[i,0].set_title('all ages',fontdict)
			elif '0-9' in key:
				if key.startswith(column):
					sns.lineplot(x="Time", y=key,ci=95,data=df,ax=ax[i,1])
					ax[i,1].set_title('<9 years',fontdict)
			elif 'Oct-19' in key:
				if key.startswith(column):
					sns.lineplot(x="Time", y=key,ci=95,data=df,ax=ax[i,2])
					ax[i,2].set_title('10-19 years',fontdict)
			elif '20-29' in key:
				if key.startswith(column):
					sns.lineplot(x="Time", y=key,ci=95,data=df,ax=ax[i,3])
					ax[i,3].set_title('20-29 years',fontdict)
			elif '30-39' in key:
				if key.startswith(column):
					sns.lineplot(x="Time", y=key,ci=95,data=df,ax=ax[i,4])
					ax[i,4].set_title('30-39 years',fontdict)
			elif '40-49' in key:
				if key.startswith(column):
					sns.lineplot(x="Time", y=key,ci=95,data=df,ax=ax[i,5])
					ax[i,5].set_title('40-49 years',fontdict)
			elif '50-59' in key:
				if key.startswith(column):
					sns.lineplot(x="Time", y=key,ci=95,data=df,ax=ax[i,6])
					ax[i,6].set_title('50-59 years',fontdict)
			elif '60-69' in key:
				if key.startswith(column):
					sns.lineplot(x="Time", y=key,ci=95,data=df,ax=ax[i,7])
					ax[i,7].set_title('60-69 years',fontdict)
			elif '70+' in key:
				if key.startswith(column):
					sns.lineplot(x="Time", y=key,ci=95,data=df,ax=ax[i,8])
...
def plot_one_intervention_horizontal(column,baseline,one_intervention_dict):
	...
	sns.lineplot(x="Time", y=column,ci=95,data=baseline,ax=ax[0])
	ax[0].set_title('Baseline')
	i=1
	for key,value in one_intervention_dict.items():
		sns.lineplot(x="Time", y=column,ci=95,data=value,ax=ax[i])
...
def plot_one_intervention_vertical(column,one_intervention_dict,top_5=False):
	...
	for key in peak_values_sorted.keys():
		sns.lineplot(x="Time", y=column,ci=95,data=one_intervention_dict[key],ax=ax[i])
...
def plot_intervention_comparison(scenarioDict,firstIntervention,secondIntervention,selectedCategory):
	...
	sns.lineplot(x="Time", y=selectedCategory,ci=95,data=scenarioDict[firstIntervention],ax=ax[0])
	ax[0].set_title(firstIntervention)
	sns.lineplot(x="Time", y=selectedCategory,ci=95,data=scenarioDict[secondIntervention],ax=ax[1])
