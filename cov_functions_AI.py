...
#-----------------------------------------------------------------
    ...
    def ode_system(self,t,y,population_frame,control_time,beta_factor):
        ...
        for i in range(population_frame.shape[0]): # age_categories
            ...
            # R
            dydt[params.R_ind + i*params.number_compartments] = (params.no_longer_infectious_rate * (1 - population_frame.p_hospitalised[i]) * y[params.I_ind + i*params.number_compartments] +
            ...
            # H
            dydt[params.H_ind + i*params.number_compartments] = (params.no_longer_infectious_rate * (population_frame.p_hospitalised[i]) * y[params.I_ind + i*params.number_compartments] -
